...
- 本地 GRPO 候选池：5,000 条，领域单跳/通用多跳构成为 `{"single_hop": 1000, "multi_hop": 4000}`，hop 分布为 `{"1": 1000, "3": 910, "2": 2586, "4": 504}`。正式训练集将在模型生成后重组为 3,000 条通用多跳、1,000 条领域多跳和 1,000 条领域单跳。
